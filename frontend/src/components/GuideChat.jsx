...
export default function GuideChat({ problemId, onInitialize }) {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      setLoading(true)
      const response = await api.askGuide({
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p className="text-sm text-muted" style={{ margin: '0.25rem 0 0 0' }}>Think out loud, I'll ask questions</p>
      </div>
